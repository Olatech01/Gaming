...
const Services = () => {
    return (
        <div className="service bg-cover bg-center bg-gradient-to-r from-gray-500 via-gray-400 to-gray-500  text-black" style={{ backgroundImage: "url('/recent.png')" }}>
            <div className="flex flex-col items-center justify-center sm:px-[20px] lg:gap-[50px] mt-[5%] py-[30px] sm:gap-[20px]">
